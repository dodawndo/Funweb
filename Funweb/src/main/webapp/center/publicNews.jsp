...
int listLimit = 10; 	// 한 페이지당 표시할 목록(게시물) 갯수
...
int listCount = boardDAO2.selectListCount();
...
ArrayList<BoardBean2> boardList2 = dao2.selectBoardList(pageNum, listLimit); 
%>
<!DOCTYPE html>
<html>
<head>
...
// 				}
				...
				%>
					<!-- 게시물 행 클릭 시 PublicNews_content.jsp 페이지로 이동 -->
